...
--
-- Host: localhost:8889
-- Generation Time: Mar 02, 2022 at 11:52 AM
...
(36, 'test', 'Les espaces avant la recette c\'est relou!', 'lupi@exemple.com', 1),
(37, 'Tarte affichage', 'Les derniers trucs de chaque pages', 'lupi@exemple.com', 1),
(41, 'Les retours', ' Les retours à la ligne\r\nC\'est\r\nCRO\r\nCRO\r\nBiennnnn', 'lupi@exemple.com', 1),
...
(43, 'Fonctions', 'c\'est complexe\r\nmais ça va finir par rentrer!!', 'lupi@exemple.com', 1),
(44, 'Je suis une recettes', 'j\'ai zéro idée', 'lupi@exemple.com', 1);
...
--
ALTER TABLE `recipes`
  MODIFY `recipe_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
