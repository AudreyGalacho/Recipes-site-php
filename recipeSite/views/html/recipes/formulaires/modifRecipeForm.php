<div class="container">
    ...
    <form action="" method="POST">
        ...
        <fieldset>
            ...
            <input type="text" row="5" class="form-controller" id="title" name="title" required="required" <?php echo 'value="' . $title . '"'; ?>>
            ...
            <textarea rows="10" class="form-controller" id="abstract" name="abstract" required="required"> <?php echo $abstract; ?></textarea>
            <div class="invalid-feedback">
